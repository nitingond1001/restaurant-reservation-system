...
class NotificationController {
    ...
    sendEmailConfirmation(userEmail, reservationDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.emailService.sendConfirmationEmail(userEmail, subject, message);
        });
    }
    sendEmailReminder(userEmail, reservationDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.emailService.sendReminderEmail(userEmail, subject, message);
        });
    }
}
